...
**Ixtli** es un analizador de CVs con IA para reclutamiento. Backend FastAPI desplegado en Railway, frontend (repo aparte) en Vercel, PostgreSQL como base de datos.
